...
```powershell
uvx --from "scriptkit @ git+https://github.com/acalderhead/py-scriptkit.git@v0.5.1" scriptkit new my_tool
```
...
#   "scriptkit[rich] @ git+https://github.com/acalderhead/py-scriptkit.git@v0.5.1",
# ]
